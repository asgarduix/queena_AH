...
import com.asi.huanan.service.repository.SysRoleRepository;

@Service
public class SysRoleService {

	private Log log = LogFactory.getLog(SysRoleService.class);
	 ...
	 * @throws Exception
	 */
	public int insert(final SysRole model, SysRoleMapper mapper) throws Exception {
	 ...
	 * @throws Exception
	 */
	// public int insert(final SysRole model, SqlSession sqlSession) throws
	// Exception {
	...
	// *
	// * @param modelList
	// * @return Key:SUCC_VAL(成功筆數,int),ERR_OBJ_LIST(失敗model,List＜SysRole＞)
	// * @throws Exception
	// */
	// public Map<String, Object> insertList(List<SysRole> modelList)
	// throws Exception
	// {
	// return repository.insertList(modelList);
	// }
	...
	// * @throws Exception
	// */
	// public SysRole queryByJobId(final String jobId) throws Exception
	// {
	...
	public List<SysRole> queryBySysRole(final SysRole model) throws Exception {
		return repository.queryBySysRole(model);
	}
	...
	public List<SysRole> queryBySysRole(final SysRole model, SqlSession sqlSession) throws Exception {
		return repository.queryBySysRole(model, sqlSession);
	}
