...
import com.asi.huanan.service.repository.SysIndexRepository;

@Service
public class SysIndexService {

	private Log log = LogFactory.getLog(SysIndexService.class);

	@Autowired
	private SysIndexRepository repository;
	 ...
	 * @throws Exception
	 */
	public int insert(final SysIndex model, SysIndexMapper mapper) throws Exception {
	 ...
	 * @throws Exception
	 */
	// public int insert(final SysIndex model, SqlSession sqlSession) throws
	// Exception {
	...
	// *
	// * @param modelList
	// * @return Key:SUCC_VAL(成功筆數,int),ERR_OBJ_LIST(失敗model,List＜SysIndex＞)
	// * @throws Exception
	// */
	// public Map<String, Object> insertList(List<SysIndex> modelList)
	// throws Exception
	// {
	// return repository.insertList(modelList);
	// }
	...
	// * @throws Exception
	// */
	// public SysIndex queryByJobId(final String jobId) throws Exception
	// {
	...
	public List<SysIndex> queryBySysIndex(final SysIndex model) throws Exception {
		return repository.queryBySysIndex(model);
	}
	...
	public List<SysIndex> queryBySysIndex(final SysIndex model, SqlSession sqlSession) throws Exception {
		return repository.queryBySysIndex(model, sqlSession);
	}
	...
	public List<SysIndex> queryBySysIndex4MultiIndexId(final List<SysIndex> models, SqlSession sqlSession)
			throws Exception {
		return repository.queryBySysIndex4MultiIndexId(models, sqlSession);
	}
